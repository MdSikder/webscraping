# Find the href of the first <a> tag of a given html document
...
print("href of the first <a> tag:", soup.find('a').attrs['href'])
# print("all href <a> tag:", soup.find_all('a').attrs['href'])
